...
for model in model_lists:
    ...
    for task in tasks:
        ...
        for step in range(1,6):
            with open(f"./results/prompt3_task_level_{task}_{model}_prompt{step}.json", "r") as f:
...
# fig.suptitle('Correctness Across Prompts for Different Tasks', fontsize=16)
...
plt.savefig('./figures/rq13d.pdf', dpi=300)
plt.show()
