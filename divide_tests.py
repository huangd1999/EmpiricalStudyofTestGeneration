...
def fetch_completion(task,model,prompt):

    path = f"./results/{task}_{model}_{prompt}.json"
    update_path = f"./results/update_{task}_{model}_{prompt}.json"
...
prompts = ["prompt3","prompt4","prompt5"]
for model in model_list:
    ...
    for task in tasks:
        ...
        for prompt in prompts:        
            ...
            fetch_completion(task, model,prompt)
